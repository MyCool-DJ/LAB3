...
while guess != number: # a while loop, with a condition that checks if the [random] guess gobal variable is not equal to the number entered by our user.
    ...
    print ("The computer takes a guess...", guess) # the computer [program] now prints its guess in the console for the user to see what the program is doing. The print statement prints a string and then the value stored in the guess variable
